...
abstract contract Implementations is Ownable {
  ...
  function getImplsStorage() internal pure returns (ImplsStorage storage stor) {
    assembly { stor.slot := _IMPLEMENTATION_SLOT }
  }
   ...
   */
  function setFunctionImplementation(bytes4 selector, address impl) external onlyOwner {
